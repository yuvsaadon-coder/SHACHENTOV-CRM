...
import type { OrgRole, BranchVolunteerInfo, VolunteerStatus, SeasonalPeriod } from '../../types'
import { FOOD_BRANCH_LEVELS, VOLUNTEER_STATUS_OPTIONS, DIST_FREQ_OPTIONS } from '../../types'
...
export function BranchDetailsPanel({ role, onClose, onEditRole }: Props) {
